...
public class ArachnidMage extends GameObject {
    ...
    public ArachnidMage(float x, float y, ID id, ObjectHandler oHandler) {
        ...
        this.bulletImage = ImageHandler.images.get("arachnidMageBullet");
    ...
    public void tick() {
        ...
        if(isShooting == true && distance < 450) { // range of the enemy
            oHandler.addObject(new EnemyBullet((int)x + 8, (int)y + 8, bulletVelX, bulletVelY, ID.EnemyBullet, oHandler, this.bulletImage));
            isShooting = false;
        }
    }
    @Override
